...
namespace ipn
{
        ...
        : App(parent)
    {
        ...
        m_scene->addEllipse( 20, 100, 50, 50, pen, QBrush(QColor(255, 0, 0) ));
        m_scene->addEllipse( 90, 100, 50, 50, pen, QBrush(QColor(0, 255, 0) ));
        m_scene->addEllipse( 160, 100, 50, 50, pen, QBrush(QColor(0, 0, 255) ));
